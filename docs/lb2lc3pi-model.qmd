...
chain_sigmac_124 = minimal_ls_decay_chain(topology_sigmac_124, quantum, propagators_sigmac_124)
```
...
external quantum numbers, but its own topology and Breit-Wigner propagators. The
