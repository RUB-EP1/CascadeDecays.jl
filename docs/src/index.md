...
| Amplitude-rank geometry | [Vortex manifolds in the Λb → Λc 3π model](@ref lb2lc3pi_vortices) | Five-dimensional determinant zeros, topology-adapted coordinates, and the interactive Pluto vortex-string lab |
...
| API | [API reference](@ref api_reference) | Autogenerated docstrings |
